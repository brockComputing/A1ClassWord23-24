...
//        {
//            int counter = 0;
//            // loop through the board (look at setupBoard) add1 to counter if symbol matches board
...
//                }
//            }
//            // if counter ==1 then output the name of the ship sunk
//            if (counter == 1)
//            {
//                Console.WriteLine($"You sunk a {GetShipHit(symbol, ships)}");
//            }
//        }
//        private static string GetShipHit(char symbol, ShipType[] ships)
//        {
