...
//                CheckIfSunk(Board[Row,Column], Board, Ships);
//                Console.WriteLine($"You have hit {OutputHit(Board[Row,Column ],Board, Ships)}");
//                Board[Row, Column] = 'h';
//            }
//        }

//        private static void CheckIfSunk(char symbol, char[,] board, ShipType[] ships)
//        {
//            int counter = 0;
//            for (int therow = 0; therow < 10; therow++)
//            {
//                for (int thecolumn = 0; thecolumn < 10; thecolumn++)
//                {
//                    if (board[therow, thecolumn] == symbol)
//                    {
//                        counter++;
//                    }
//                }
...
//            if (counter == 1)
//            {
//                Console.WriteLine($"You have sunk a {OutputHit(symbol , board, ships)} ");
//            }
//        }
//        private static string OutputHit(char symbol, char[,] board, ShipType[] ships)
//        {
//            foreach (var item in ships)
//            {
//                if (symbol == item.Name[0])
//                {
//                    return item.Name;
//                }
//            }
