...
//                Console.WriteLine($"It took {noGoes} goes to sink all thr ships");
//                Console.WriteLine("Would you like to save the score to the high file");
//                ans = Console.ReadLine();
//                if (ans.ToUpper() == "Y")
//                {
//                    Console.WriteLine("Enter your name");
//                    playerName = Console.ReadLine();
//                    StreamWriter hiScores = new StreamWriter("hiScores.txt", true);
//                    hiScores.WriteLine(playerName);
//                    hiScores.WriteLine(noGoes);
//                    hiScores.Close();
//                }
//                Console.WriteLine();
//            }
