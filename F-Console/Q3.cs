...
//                OutputHit(Row, Column, Board, Ships);
//                Board[Row, Column] = 'h';
//            }
//        }

//        private static void OutputHit(int row, int column, char[,] board, ShipType[] ships)
//        {
//            foreach (var item in ships)
//            {
//                //Console.WriteLine(item.Name[0]);
//                if (board[row,column] == item.Name[0])
//                {
//                    Console.WriteLine($"You have hit a {item.Name}");
//                }
//            }
//        }
